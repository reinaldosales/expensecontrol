...
public class CardController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Id,Number,Type,Brand,Limit,Value,InvoiceClosingDate,User")] Card card)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Type,Brand,Limit,Value,InvoiceClosingDate,User")] Card card)
    {
        if (id != card.Id)
        {
            return NotFound();
